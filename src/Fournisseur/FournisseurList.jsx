  ...
  const handleSubmit = (e) => {
    ...
    axios({
      ...
      .catch((error) => {
        console.error(
          `Erreur lors de ${
            editingFournisseur ? "la modification" : "l'ajout"
          } du fournisseur:`,
          error
        );
        Swal.fire({
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th style={tableHeaderStyle}>Abréviation</th>
                    <th style={tableHeaderStyle}>Code Postal</th>
                    <th style={tableHeaderStyle}>ICE</th>
