  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const selectedPrdsData = selectedProductsData.map((selectProduct) => {
        // const selecProduct = produits.find(
        //   (product) => product.id === selectProduct.productId
        // );
        ...
        if (selectProduct) {
          return {
            ...
            prix_vente: selectProduct.prixVente,
          };
        } else {
          console.error(
            `Product with ID ${selectProduct.productId} not found in produits array.`
          );
