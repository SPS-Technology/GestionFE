...
const PrintList = ({ tableId, title, ReclamationList, filtredreclamations }) => {
    const handlePrint = () => {
                ...
                <table>
                  <thead>
                    <tr class="table-header">
                      ...
                      <th>Traitement de Réclamation</th>
                  ...
                  <tbody>
                    ${filtredreclamations.map((reclamation) => `
                      <tr key=${reclamation.id}>
                        ...
                        <td>${reclamation.status_reclamation}</td>
                        <td>${reclamation.traitement_reclamation}</td>
                        <td>${reclamation.date_traitement}</td>
                      </tr>
                    `).join("")}
                  </tbody>
                </table>
